...
Version  : 1.1.4
Release  : 25
URL      : http://pypi.debian.net/nodeenv/nodeenv-1.1.4.tar.gz
Source0  : http://pypi.debian.net/nodeenv/nodeenv-1.1.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1499271867
